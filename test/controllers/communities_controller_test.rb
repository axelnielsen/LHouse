...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { address: @community.address, email: @community.email, nombre: @community.nombre, phone: @community.phone, website: @community.website }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { address: @community.address, email: @community.email, nombre: @community.nombre, phone: @community.phone, website: @community.website }
    assert_redirected_to community_path(assigns(:community))
  end
